...
public:
  ...
  void argmax_matrix_later(vector<vector<Ctxt>>& ctxt_mat, const vector<Ctxt>& ctxt_in) const;
  
  // argmax, if a = [1, 2, 3, 15, 15], it returns 4, i.e., the 5th is the maximum
  void argmax_later(Ctxt& ctxt_res, const vector<Ctxt>& ctxt_in) const;

  void argmax_matrix_former(vector<vector<Ctxt>>& ctxt_mat, const vector<Ctxt>& ctxt_in) const;
  // argmax, if a = [1, 2, 3, 15, 15], it returns 3, i.e., the 4th is the maximum
  void argmax_former(Ctxt& ctxt_res, const vector<Ctxt>& ctxt_in) const;

  void argmax(Ctxt& ctxt_res, const vector<Ctxt>& ctxt_in, const int former_later) const;
